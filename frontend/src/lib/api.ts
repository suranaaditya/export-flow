...
export const API = {
	...
	partyContacts: 'exportflow.api.get_party_contacts',
	addPartyAddress: 'exportflow.api.add_party_address',
	addPartyContact: 'exportflow.api.add_party_contact',
	setPartyPrimaryAddress: 'exportflow.api.set_party_primary_address',
	setPartyPrimaryContact: 'exportflow.api.set_party_primary_contact',
	removePartyAddress: 'exportflow.api.remove_party_address',
	removePartyContact: 'exportflow.api.remove_party_contact',
